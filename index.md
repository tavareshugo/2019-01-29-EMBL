...
address: "Meyerhofstraße 1, 69117 Heidelberg, Germany"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "49.384368,8.709070"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "29-31 Jan 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 - 17:30"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-01-29      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-01-31        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Florian Huber", "Hugo Tavares", "Thea Van Rossum", "Georg Zeller"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Toby Hodges", "Malvika Sharan"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2019-01-29-EMBL            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
{% endcomment %}
<p id="requirements">
  <strong>Requirements:</strong> All of the software necessary for this workshop 
  is available on our training computers. However, participants are welcome to bring 
  their own laptop. If you bring your own laptop, please see the 
  <a href="#setup">setup instructions below</a>). 
